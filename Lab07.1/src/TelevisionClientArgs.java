...
class TelevisionClientArgs
{
    public static void main(String[] args)
    {
        ...
        if (numArgs != 3)
        {
            ...
            System.out.println("Usage : java TelevisionClientArgs <brand> <volume> <display>");
        ...
        else
        {
            ...
            //Checks to see if arg[2] equals anything in DisplayType enum.
            boolean valid = false;
            for (DisplayType x : DisplayType.values())
            {
                //If match is found then set DisplayType to args[2]
            ...
            if (!valid)
            {
                System.out.println("not a valid DisplayType");
            }
